...
//skin
if (skin && skin != "default") document.write('<link href="' + WebContent + 'miniui/themes/' + skin + '/skin.css" rel="stylesheet" type="text/css" />');

//mode
if (mode && mode != "default") document.write('<link href="' + WebContent + 'miniui/themes/default/' + mode + '-mode.css" rel="stylesheet" type="text/css" />');

//icon
document.write('<link href="' + WebContent + 'miniui/themes/icons.css" rel="stylesheet" type="text/css" />');
